                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if (isset($banner_data))
                                <form action="{{ route('outer_banner.update', @$banner_data->id) }}" method="post"
                                    class="form" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                @else
                                    <form action="{{ route('outer_banner.store') }}" method="post" class="form"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="image">Image <span class="text-danger">*</span>   (Preferred Image dimension : 1920 x 530)</label>
