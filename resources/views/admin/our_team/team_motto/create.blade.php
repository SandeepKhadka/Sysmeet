...
@section('main-content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="reply">{{ isset($team_motto_data) ? 'Update' : 'Add' }}</li>
        </ol>
    </nav>
    <div class="content">
        <div>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="m-0 text-left font-weight-bold" style="padding: 10px">Team Motto
                        {{ isset($team_motto_data) ? 'Update' : 'Add' }}</h4>
                    <div class="card">
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea type="text" id="team_motto" name="team_motto" class="form-control" required style="resize: none"
                            ...
                            <button type="submit" class="btn btn-success float-right"
                                value="Sumbit">{{ isset($team_motto_data) ? 'Update' : 'Add' }}</button>
