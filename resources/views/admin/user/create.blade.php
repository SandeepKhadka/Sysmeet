...
@section('main-content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="reply">{{ isset($user_data) ? 'Update' : 'Add' }}</li>
        </ol>
    </nav>
    <div class="content">
        <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="full_name" name="full_name"
                                        value="{{ @$user_data->full_name }}" class="form-control" required
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="username" name="username"
                                        value="{{ @$user_data->username }}" class="form-control" required>
                                    @error('username')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="password" id="password" name="password"
                                        value="{{ @$user_data->password }}" class="form-control">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <button type="submit" class="btn btn-success float-right"
                                value="Sumbit">{{ isset($user_data) ? 'Update' : 'Add' }}</button>
