 ...
 <rs-module-wrap id="rev_slider_1_1_wrapper" data-source="gallery">
    <rs-module id="rev_slider_1_1" style="" data-version="6.5.9">
        <rs-slides>
            <rs-slide data-key="rs-1" data-title="Slide" data-thumb="https://via.placeholder.com/1920x694/616161/818181?text=1920x694+slider-mainbg-001.jpg" data-anim="ei:d;eo:d;s:d;r:0;t:fade;sl:d;">

                <img src="https://via.placeholder.com/1920x694/616161/818181?text=1920x694+slider-mainbg-001.jpg" title="slider-img-01.jpg" width="1920" height="694" class="rev-slidebg tp-rs-img" data-no-retina><!--
                --><rs-layer
            ...
            <rs-slide data-key="rs-4" data-title="Slide" data-thumb="https://via.placeholder.com/1920x694/616161/818181?text=1920x694+slider-mainbg-002.jpg" data-anim="ei:d;eo:d;s:d;r:0;t:fade;sl:d;">

                <img src="https://via.placeholder.com/1920x694/616161/818181?text=1920x694+slider-mainbg-002.jpg" title="slider-img-02.jpg" width="1920" height="694" class="rev-slidebg tp-rs-img" data-no-retina>
                <!--
                --><rs-layer
                ...
                --><a
                    ...
                    data-frame_999="o:0;st:w;sR:7360;"
                    style="z-index:15;font-family:'Lato', sans-serif;"
                ><i class="icon-right text-center"></i><span>see more projects</span>
                </a><!--
...
<div class="site-main">
            ...
            <div class="row mt_140 res-991-mt-40">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-services style1">
                        ...
                        <div class="featured-thumbnail">
                            <a href="it-consultancy.html"><img width="740" height="500" class="img-fluid auto_size" src="https://via.placeholder.com/740x500?text=740x500+services-01.jpg" alt="image"></a>
                        ...
                        <div class="featured-content">
                            ...
                            <div class="ser_readmore"><a href="it-consultancy.html" class="cmt-btn cmt-btn-size-md cmt-icon-btn-right cmt-btn-color-skincolor btn-inline">Discover Now<i class="icon-right"></i></a></div>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-services style1">
                        <!-- featured-thumbnail -->
                        <div class="featured-thumbnail">
                            <a href="experience-design.html"><img width="740" height="500" class="img-fluid auto_size" src="https://via.placeholder.com/740x500?text=740x500+services-02.jpg" alt="image"></a>
                        </div><!-- featured-thumbnail end-->
                        <div class="featured-content">
                            ...
                            <div class="ser_num"></div>
                            <div class="ser_readmore"><a href="experience-design.html" class="cmt-btn cmt-btn-size-md cmt-icon-btn-right cmt-btn-color-skincolor btn-inline">Discover Now<i class="icon-right"></i></a></div>
                        </div>
                    </div><!-- featured-imagebox-services end-->
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-services style1">
                        <!-- featured-thumbnail -->
                        <div class="featured-thumbnail">
                            <a href="digital-services.html"><img width="740" height="500" class="img-fluid auto_size" src="https://via.placeholder.com/740x500?text=740x500+services-03.jpg" alt="image"></a>
                        </div><!-- featured-thumbnail end-->
                        <div class="featured-content">
                            ...
                            <div class="ser_num"></div>
                            <div class="ser_readmore"><a href="digital-services.html" class="cmt-btn cmt-btn-size-md cmt-icon-btn-right cmt-btn-color-skincolor btn-inline">Discover Now<i class="icon-right"></i></a></div>
                        </div>
                    </div><!-- featured-imagebox-services end-->
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-md-12">
                    <div class="ttm_single_image-wrapper d-table border-rad_5 overflow-hidden">
                        <img width="1140" height="1300" class="img-fluid" src="https://via.placeholder.com/1140x1300?text=1140x1300+single-img-01.jpg" alt="single-01">
                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="d-table border-rad_5 overflow-hidden mb-15 res-991-mb-0 res-767-mt-30">
                                    <div class="ttm_single_image-wrapper text-start">
                                        <img width="810" height="519" class="img-fluid" src="https://via.placeholder.com/810x519?text=810x519+single-img-02.jpg" alt="single-02">
                                        <div class="bg-base-dark text-left pt-15 pb-15 pl-25 pr-25">
                                            <p class="mb-5"><img src="images/star-01.png" alt="rate-star"></p>
                                            <p class="text-base-white lh-base mb-0">Rated 4.7 out of 5 based on <br>over<strong><span class="text-base-skin"> 1000+ Reviews</span></strong></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-title title-style-center_text res-991-mb_20">
                        <div class="title-header">
                            ...
                            <h2 class="title text-base-white">A Collection of Our Work</h2>
                        </div>
                    </div><!-- section title end -->
                </div>
                <div class="col-lg-12">
                    <div class="d-table p-20 bg-base-skin position-relative border-rad_5 text-center m-auto me-lg-0 ms-lg-auto mt_110 res-991-mt-40 cmt-play-icon">
                        <div class="cmt-play-icon-animation">
                            <a href="https://youtu.be/7e90gBu4pas" target="_self" class="cmt_prettyphoto">
                                <div class="cmt-icon cmt-icon_element-border border-2 cmt-icon_element-color-white cmt-icon_element-size-md cmt-icon_element-style-rounded mb-0">
                                    <i class="fas fa-play fs-20"></i>
                                </div>
                            </a>
                        </div>
                    </div>
    ...
    <section class="cmt-row padding_zero-section clearfix">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="cmt-bg cmt-col-bgcolor-yes bg-base-white cmt-bg spacing-1 border-rad_10 overflow-visible mb_15">
                        <div class="row">
                            <div class="col-lg-6">
                                <!-- section title -->
                                <div class="section-title">
                            ...
                            <div class="col-lg-6">
                                ...
                                <ul class="cmt-list cmt-bordered-lists cmt-list-style-icon cmt-list-icon-color-skincolor text-base-dark">
                                    <li><i class="fas fa-arrow-right"></i><span class="cmt-list-li-content">Connect to a wide range of API’s that will innovate and increase customer</span></li>
                                    <li><i class="fas fa-arrow-right"></i><span class="cmt-list-li-content">Visitors can browse with peace of mind without exposing any personal data.</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style1">
                                    ...
                                    <div class="featured-hover-content">
                                        ...
                                        <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" href="it-consultancy.html">More Details<i class="icon-right"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style1">
                                    ...
                                    <div class="featured-hover-content">
                                        ...
                                        <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" href="experience-design.html">More Details<i class="icon-right"></i></a>
                                    </div>
                                </div><!-- featured-icon-box end-->
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style1">
                                    ...
                                    <div class="featured-hover-content">
                                        ...
                                        <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" href="digital-services.html">More Details<i class="icon-right"></i></a>
                                    </div>
                                </div><!-- featured-icon-box end-->
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style1">
                                    ...
                                    <div class="featured-hover-content">
                                        ...
                                        <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" href="data-structuring.html">More Details<i class="icon-right"></i></a>
                                    </div>
                                </div><!-- featured-icon-box end-->
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style1">
                                    ...
                                    <div class="featured-hover-content">
                                        ...
                                        <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" href="advisory-services.html">More Details<i class="icon-right"></i></a>
                                    </div>
                                </div><!-- featured-icon-box end-->
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style1 active">
                                    ...
                                    <div class="featured-hover-content">
                                        ...
                                        <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white" href="content-engineering.html">More Details<i class="icon-right"></i></a>
                                    </div>
                                </div><!-- featured-icon-box end-->
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-icon-box icon-align-top-content style2">
                        ...
                        <div class="featured-content">
                            ...
                            <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-skincolor" href="contact-us.html">view more<i class="icon-right"></i></a>
                        </div>
                    </div><!-- featured-icon-box end-->
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-icon-box icon-align-top-content style2">
                        ...
                        <div class="featured-content">
                            ...
                            <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-skincolor" href="blog.html">view more<i class="icon-right"></i></a>
                        </div>
                    </div><!-- featured-icon-box end-->
                </div>
            </div>
    ...
    <section class="cmt-row team-section padding_zero-section cmt-bg clearfix">
        ...
        <div class="container">
            <!-- row -->
            <div class="row slick_slider mt_240 res-991-mt-40" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "arrows":false, "dots":false, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":992,"settings":{"slidesToShow": 3}}, {"breakpoint":778,"settings":{"slidesToShow": 2}}, {"breakpoint":575,"settings":{"slidesToShow": 1}}]}'>
                <div class="cmt-box-col-wrapper col-lg-3">
                    <!-- featured-imagebox-team -->
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="https://via.placeholder.com/535x500?text=535x500+team-img01.jpg" alt="image"> 
                        </div>
                        <div class="featured-content">
                            ...
                            <div class="featured-view-more">
                                <a class="cmt-btn btn-inline cmt-btn-size-md cmt-btn-color-skincolor" href="team-details.html">more details</a>
                            </div>
                            <div class="featured-iconbox cmt-media-link">
                                <div class="media-block">
                                    <div class="media-btn"><i class="icon-plus"></i></div>
                                    <ul class="social-icons list-inline">
                                        <li class="social-facebook"><a href="https://www.facebook.com/cymolthemes.191219"><i class="ti ti-facebook"></i></a></li>
                                        <li class="social-twitter"><a href="https://twitter.com/CymolThemes"><i class="ti ti-twitter-alt"></i></a></li>
                                        <li class="social-pinterest"><a href="https://in.pinterest.com/cymolthemes/"><i class="ti ti-pinterest"></i></a></li>
                                        <li class="social-instagram"><a href="https://www.instagram.com/cymol_themes/"><i class="ti ti-instagram"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="https://via.placeholder.com/535x500?text=535x500+team-img02.jpg" alt="image">
                        </div>
                        <div class="featured-content">
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="https://via.placeholder.com/535x500?text=535x500+team-img03.jpg" alt="image"> 
                        </div>
                        <div class="featured-content">
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="https://via.placeholder.com/535x500?text=535x500+team-img04.jpg" alt="image"> 
                        </div>
                        <div class="featured-content">
                    ...
                    <div class="slick_slider" data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "arrows":false, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":1200,"settings":{"slidesToShow": 5}}, {"breakpoint":1024,"settings":{"slidesToShow": 4}}, {"breakpoint":777,"settings":{"slidesToShow": 3}},{"breakpoint":575,"settings":{"slidesToShow": 2}},{"breakpoint":380,"settings":{"slidesToShow": 1}}]}'>
                        ...
                        <div class="client-box">
                            <div class="cmt-client-logo-tooltip">
                                <div class="cmt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="128" height="60" class="img-fluid" src="https://via.placeholder.com/128x60?text=128x60+client-02.png" alt="image">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="client-box">
                            <div class="cmt-client-logo-tooltip">
                                <div class="cmt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="142" height="60" class="img-fluid" src="https://via.placeholder.com/142x60?text=142x60+client-03.png" alt="image">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="client-box">
                            <div class="cmt-client-logo-tooltip">
                                <div class="cmt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="182" height="61" class="img-fluid" src="https://via.placeholder.com/182x61?text=182x61+client-04.png" alt="image">
                                    </div>
                                </div>
                            </div>
                        </div>
