                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="sub_title" name="sub_title" value="{{ @$our_help_data->sub_title }}"
                                        required class="form-control" required disabled>
                                    @error('sub_title')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                            ...
                            <a href="{{ route('service_our_help.index') }}" type="submit" class="btn btn-primary float-right"
