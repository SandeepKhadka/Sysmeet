     ...
     <rs-module id="rev_slider_1_1" style="" data-version="6.5.9">
         <rs-slides>
             <rs-slide data-key="rs-1" data-title="Slide">
                 @if (isset($main_banner) && $main_banner != null)
                     <img src="{{ asset('/uploads/main_banner/' . $main_banner->image) }}" title="slider-img-01.jpg" width="1920" height="694"
                ...
                -->
                 <rs-layer id="slider-1-slide-1-layer-0" data-type="text" data-color="#ff382f" data-rsp_ch="on"
                     ...
                     data-frame_1="st:190;sp:1200;sR:190;" data-frame_1_mask="u:t;" data-frame_999="o:0;st:w;sR:7610;"
                     style="z-index:9;font-family:'Lato', sans-serif;">The soul
                     of Tech
                 </rs-layer>
                 <!--
                ...
                -->
                 <rs-layer id="slider-1-slide-1-layer-1" data-type="text" data-color="#05255f" data-rsp_ch="on"
                     ...
                     data-frame_999="o:0;st:w;sR:7490;" style="z-index:10;font-family:'Lato', sans-serif;">Serving
                     IT
                 </rs-layer>
                 <!--
                ...
                -->
                 <rs-layer id="slider-1-slide-1-layer-2" data-type="text" data-color="#05255f" data-rsp_ch="on"
                     ...
                     data-frame_999="o:0;st:w;sR:7360;" style="z-index:11;font-family:'Lato', sans-serif;">To Served
                     You
                 </rs-layer>
                 <!--
                ...
                -->
                 <rs-layer id="slider-1-slide-1-layer-3" data-type="text" data-color="#676b72" data-rsp_ch="on"
                     ...
                     data-frame_999="o:0;st:w;sR:7120;" style="z-index:12;font-family:'Lato', sans-serif;">All types
                     of
                     IT services according to the market demand!
                 </rs-layer>
                 <!--

                --><a id="slider-1-slide-1-layer-4" class="rs-layer cmt_prettyphoto"
                     href="https://www.youtube.com/watch?v=7e90gBu4pas" target="_self" data-type="text"
                     data-color="#05255f" data-rsp_ch="on"
                     ...
                     data-frame_0="sX:0.9;sY:0.9;" data-frame_1="e:power2.inOut;st:1150;sp:500;sR:1150;"
                     ...
                     style="z-index:13;font-family:'Lato', sans-serif;"><i class="fas fa-play"></i>

                 </a>
                 <!--

                -->
                 <rs-layer id="slider-1-slide-1-layer-6" data-type="text" data-color="#05255f" data-rsp_ch="on"
                     data-xy="x:l,l,c,c;xo:166px,166px,0,0;y:t,t,t,m;yo:438px,438px,353px,103px;"
                     data-text="w:normal;s:19,19,16,14;l:25,25,20,20;fw:600;" data-frame_0="y:-100%;"
                     data-frame_0_mask="u:t;" data-frame_1="st:1260;sp:500;sR:1260;" data-frame_1_mask="u:t;"
                     data-frame_999="o:0;st:w;sR:7240;" style="z-index:14;font-family:'Lato', sans-serif;">See Our
                     Video
                 </rs-layer>
                 <!--

                -->
                 <rs-layer id="slider-1-slide-1-layer-7" data-type="text" data-color="#676b72" data-rsp_ch="on"
                     data-xy="x:l,l,c,c;xo:166px,166px,584px,706px;yo:465px,465px,255px,241px;"
                     data-text="w:normal;s:15,15,14,8;l:25,25,20,12;" data-vbility="t,t,f,t" data-frame_0="y:-100%;"
                     data-frame_0_mask="u:t;" data-frame_1="st:1260;sp:500;sR:1260;" data-frame_1_mask="u:t;"
                     data-frame_999="o:0;st:w;sR:7240;" style="z-index:15;font-family:'Lato', sans-serif;">A
            ...
            -->
             ...
             <rs-slide data-key="rs-4" data-title="Slide"
                 ...
                 <img src="https://via.placeholder.com/1920x694/616161/818181?text=1920x694+slider-mainbg-002.jpg"
                     title="slider-img-02.jpg" width="1920" height="694" class="rev-slidebg tp-rs-img"
                     data-no-retina>
                 <!--
                -->
                 <rs-layer id="slider-1-slide-4-layer-0" data-type="text" data-color="#ff382f" data-rsp_ch="on"
                     ...
                     data-frame_999="o:0;st:w;sR:7610;" style="z-index:9;font-family:'Lato', sans-serif;">Need
                     Professional
                 </rs-layer>
                 <!--
                ...
                -->
                 <rs-layer id="slider-1-slide-4-layer-1" data-type="text" data-color="#05255f" data-rsp_ch="on"
                     ...
                     data-text="w:normal;s:66,66,58,50;l:76,76,80,60;fw:700;" data-frame_0="y:-100%;"
                     data-frame_0_mask="u:t;" data-frame_1="st:310;sp:1200;sR:310;" data-frame_1_mask="u:t;"
                     data-frame_999="o:0;st:w;sR:7490;" style="z-index:10;font-family:'Lato', sans-serif;">Simplify IT
                     to
                 </rs-layer>
                 <!--
                ...
                -->
                 <rs-layer id="slider-1-slide-4-layer-2" data-type="text" data-color="#05255f" data-rsp_ch="on"
                     ...
                     data-text="w:normal;s:66,66,58,50;l:76,76,80,60;fw:700;" data-frame_0="y:-100%;"
                     data-frame_0_mask="u:t;" data-frame_1="st:440;sp:1200;sR:440;" data-frame_1_mask="u:t;"
                     data-frame_999="o:0;st:w;sR:7360;" style="z-index:11;font-family:'Lato', sans-serif;">Multiply
                     Profits
                 </rs-layer>
                 <!--
                ...
                -->
                 <rs-layer id="slider-1-slide-4-layer-3" data-type="text" data-color="#676b72" data-rsp_ch="on"
                     ...
                     data-frame_0_mask="u:t;" data-frame_1="st:680;sp:1200;sR:680;" data-frame_1_mask="u:t;"
                     data-frame_999="o:0;st:w;sR:7120;" style="z-index:12;font-family:'Lato', sans-serif;">All types
                     of IT services according to the market demand!
                 </rs-layer>
                 <!--
                     ...
                     <div class="featured-imagebox featured-imagebox-services style1">
                         ...
                         <div class="featured-thumbnail">
                             <a href="it-consultancy.html"><img width="740" height="500"
                                     ...
                                     src="https://via.placeholder.com/740x500?text=740x500+services-01.jpg"
                                     alt="image"></a>
                 ...
                 <div class="col-xl-6 col-md-12">
                     <div class="ttm_single_image-wrapper d-table border-rad_5 overflow-hidden">
                         <img width="1140" height="1300" class="img-fluid"
                             src="https://via.placeholder.com/1140x1300?text=1140x1300+single-img-01.jpg"
                             alt="single-01">
                     </div>
                 ...
                 <div class="col-xl-6">
                     <div class="res-1199-pt-40">
                         ...
                         <div class="section-title">
                             ...
                             <div class="title-desc">
                                 <p>Devfox is high-tech industries play an important role in the modern economy & often
                                     experience significantly higher pay than other industries. And Digital solutions
                                     have transformed the world’s for web applications reliable & solutions.</p>
                             </div>
                         </div><!-- section title end -->
     ...
     <section class="cmt-row services-section bg-img2 cmt-bgimage-yes cmt-bg clearfix">
         <div class="container">
             ...
             <div class="row">
                 ...
                 <div class="col-lg-12">
                     <div
                         class="d-table p-20 bg-base-skin position-relative border-rad_5 text-center m-auto me-lg-0 ms-lg-auto mt_110 res-991-mt-40 cmt-play-icon">
                         <div class="cmt-play-icon-animation">
                             <a href="https://youtu.be/7e90gBu4pas" target="_self" class="cmt_prettyphoto">
                                 <div
                                     class="cmt-icon cmt-icon_element-border border-2 cmt-icon_element-color-white cmt-icon_element-size-md cmt-icon_element-style-rounded mb-0">
                             ...
                             <div class="col-lg-3 col-md-6 col-sm-6">
                                 ...
                                 <div class="featured-icon-box icon-align-top-content style1">
                                     ...
                                     <div class="featured-hover-content">
                                         ...
                                         <div class="featured-desc">
                                             <p>The process of storing copies of data, organizations against of data.
                                             </p>
                                         </div>
                                         <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white"
                             ...
                             <div class="col-lg-3 col-md-6 col-sm-6">
                                 ...
                                 <div class="featured-icon-box icon-align-top-content style1 active">
                                     ...
                                     <div class="featured-hover-content">
                                         ...
                                         <div class="featured-desc">
                                             <p>Any activities designed to protect the usability & integrity of network
                                             </p>
                                         </div>
                                         <a class="cmt-btn btn-inline cmt-icon-btn-right cmt-btn-size-md cmt-btn-color-white"
                     ...
                     <div class="featured-imagebox featured-imagebox-team style1">
                         <div class="featured-thumbnail">
                             <img class="img-fluid" width="535" height="500"
                                 src="https://via.placeholder.com/535x500?text=535x500+team-img01.jpg" alt="image">
                         </div>
                         <div class="featured-content">
                                 ...
                                 <div class="cmt-client-logo-tooltip-inner">
                                     <div class="client-thumbnail">
                                         <img width="152" height="60" class="img-fluid"
                                             src="https://via.placeholder.com/152x60?text=152x60+client-01.png"
                                             alt="image">
                                     </div>
                                 </div>
                             </div>
