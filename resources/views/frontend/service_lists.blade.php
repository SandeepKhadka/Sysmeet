                    ...
                    <div class="col-lg-12">
                        <div class="cmt-page-title-row-inner">
                            <div class="page-title-heading">
                                <h2 class="title">{{ @$single_service_list->title }}</h2>
                            </div>
                            <div class="breadcrumb-wrapper">
                                <span>
                                    <a title="Homepage" href="index.html">Home</a>
                                </span>
                                <span>{{ @$single_service_list->title }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="cmt-service-single-content-area">
                                {{-- <div class="ttm_fatured_image-wrapper mb-40 res-575-mb-20">
                                    <img width="770" height="500" class="img-fluid"
                                        src="{{ asset('/uploads/our_help/' . @$single_service_list->image) }}"
                                        alt="services-1">
                                </div> --}}
                                <div class="cmt-service-description">
                                    <h3>{{ @$single_service_list->title }}</h3>
                                    <p>{!! html_entity_decode(@$single_service_list->description) !!}</p>
                                    <div class="row">
